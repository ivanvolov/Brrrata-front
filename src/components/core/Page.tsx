      ...
      <section className="w-full max-w-6xl mx-auto my-4 pb-16">
        <div className="bg-white p-8 rounded-lg shadow-lg">
          ...
          <p className="text-lg leading-relaxed">
            Hello, welcome to Holland! The land of windmills, cheese, and fields
            of beautiful flowers! But flowers? Maaaan, forget the tulips. Here,
            we're cranking out pure, unfiltered chaos. I mean, it's Holland—so
            why settle for flowers when you could be minting cheese-fueled,
            hallucinogenic Brrrata tokens? Let's freaking go! Here are the
          ...
          <ol className="list-decimal list-inside mt-4 text-lg">
            <li className="mt-4">
              ...
              <ul className="list-disc list-inside mt-2">
                ...
                <li>
                  ...
                  is printed. Early minting = cheap cheese.
                </li>
                <li>
                  <strong>33 Phases:</strong> We got 33 phases, each lasting 3
                  days. Every new phase? Less Brrrata, more value, more hype.
                </li>
              </ul>
            </li>
            ...
            <li className="">
              <strong>Spin the Wheel of Cheese-tiny:</strong> Mint some tokens
              and spin the wheel. Maybe you double your cheese, maybe Gordon
              Ramsay yells at you—it’s all fair game.
            </li>
            ...
            <li className="mt-4">
              ...
              <ul className="list-disc list-inside mt-2">
                ...
                <li>
                  <strong>20% Staking Rewards:</strong> 20% of all cheese is set
                  aside for stakers. But don't let it burn or you’ll end up with
                  sad, crusty cheese.
                </li>
              </ul>
            </li>
